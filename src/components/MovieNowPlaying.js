...
class MovieNP extends Component {
  constructor(props) {
    super(props)
    this.state = {
      show:true
  ...
  showMovies() {
    const urlString = "https://api.themoviedb.org/3/movie/now_playing?api_key=ea56a12189ee8150069aceef86a26608"
    $.ajax({
        url: urlString,
