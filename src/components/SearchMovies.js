...
class SearchFieldMovies extends Component {
  constructor(props) {
    super(props)
    this.state = {
      show:true
  ...
  searchQuery(query) {
    ...
    const urlString = "https://api.themoviedb.org/3/search/movie?api_key=ea56a12189ee8150069aceef86a26608&query=" + query
...
export default SearchFieldMovies